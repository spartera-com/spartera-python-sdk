...
class TestEndpointsUpdate(unittest.TestCase):
    """EndpointsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointsUpdate:
        """Test EndpointsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointsUpdate`
        """
        model = EndpointsUpdate()
        if include_optional:
