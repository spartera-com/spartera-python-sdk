...
class TestAssetsInput(unittest.TestCase):
    """AssetsInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetsInput:
        """Test AssetsInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetsInput`
        """
        model = AssetsInput()
        if include_optional:
            return AssetsInput(
