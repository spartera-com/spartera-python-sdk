...
class TestEndpointsInput(unittest.TestCase):
    """EndpointsInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointsInput:
        """Test EndpointsInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointsInput`
        """
        model = EndpointsInput()
        if include_optional:
