...
class TestPostPublicationsUpdate(unittest.TestCase):
    """PostPublicationsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPublicationsUpdate:
        """Test PostPublicationsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPublicationsUpdate`
        """
        model = PostPublicationsUpdate()
        if include_optional:
    ...
    def testPostPublicationsUpdate(self):
        """Test PostPublicationsUpdate"""
