...
class TestPostsUpdate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostsUpdate:
        """Test PostsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostsUpdate`
        """
        model = PostsUpdate()
        if include_optional:
            return PostsUpdate(
