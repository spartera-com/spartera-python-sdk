...
**price_credits** | **int** | Credits deducted from the buyer&#39;s pool per successful (200 OK) request. Same credit pool as assets. price_usd kept for billing records / dashboards. | [optional] 
...
json = "{}"
# create an instance of EndpointsInput from a JSON string
endpoints_input_instance = EndpointsInput.from_json(json)
# print the JSON string representation of the object
print(EndpointsInput.to_json())

# convert the object into a dict
endpoints_input_dict = endpoints_input_instance.to_dict()
# create an instance of EndpointsInput from a dict
endpoints_input_from_dict = EndpointsInput.from_dict(endpoints_input_dict)
```
