...
class CompaniesUpdate(BaseModel):
    ...
    company_handle: Optional[StrictStr] = None
    company_domain: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["industry_id", "country_id", "company_name", "company_description", "company_handle", "company_domain", "credits_balance", "accepted_eula", "stripe_account_id", "stripe_account_status"]
