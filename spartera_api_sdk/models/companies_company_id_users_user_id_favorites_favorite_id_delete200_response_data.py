...
class CompaniesCompanyIdUsersUserIdFavoritesFavoriteIdDelete200ResponseData(BaseModel):
    """
    CompaniesCompanyIdUsersUserIdFavoritesFavoriteIdDelete200ResponseData
    """ # noqa: E501
    favorite_id: StrictStr = Field(description="ID of the deleted favorites")
    __properties: ClassVar[List[str]] = ["favorite_id"]
