...
class Connections(BaseModel):
    ...
    connection_id: Optional[StrictStr] = Field(default=None, description="Unique identifier.")
    ...
    __properties: ClassVar[List[str]] = ["date_created", "last_updated", "connection_id", "user_id", "engine_id", "company_id", "credential_type", "name", "description", "provider_domain", "verified_usage_ability"]
