...
class Cloudprovider(BaseModel):
    ...
    name: StrictStr
    parent_company: Optional[StrictStr] = None
    marketing_homepage_url: Optional[StrictStr] = None
    date_created: Optional[StrictStr] = None
    last_updated: Optional[StrictStr] = None
    active: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider_id", "name", "parent_company", "marketing_homepage_url", "date_created", "last_updated", "active"]
