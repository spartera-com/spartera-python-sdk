...
class Apikey(BaseModel):
    ...
    expiration_date_utc: Optional[StrictStr] = None
    date_created: Optional[StrictStr] = None
    last_updated: Optional[StrictStr] = None
    active: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["api_key_id", "user_id", "company_id", "role_id", "token", "name", "expiration_date_utc", "date_created", "last_updated", "active"]
