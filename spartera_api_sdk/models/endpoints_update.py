...
class EndpointsUpdate(BaseModel):
    ...
    export_enabled: Optional[StrictBool] = Field(default=None, description="Whether this endpoint supports bulk export to GCS. When True, buyers can request delivery=gcs with format=csv|parquet. Independent of max_records_per_request, which only governs inline JSON.")
    ...
    __properties: ClassVar[List[str]] = ["date_created", "last_updated", "user_id", "company_id", "connection_id", "industry_id", "auc_id", "approval_status", "approved_by_user_id", "approved_at", "sell_in_marketplace", "name", "slug", "description", "detailed_description", "top_questions", "source_schema_name", "source_table_name", "customer_name", "endpoint_schema", "rate_limit_number", "rate_limit_period", "rate_limit_granularity", "access_method", "access_whitelist", "status", "data_time_period_start", "data_time_period_end", "date_collection_start", "geographic_coverage_type", "geographic_coverage_details", "data_source_refresh_frequency", "tags", "last_accessed", "max_records_per_request", "export_enabled", "max_records_per_export", "sample_response", "active"]
