...
class Assets(BaseModel):
    ...
    asset_id: Optional[StrictStr] = Field(default=None, description="Unique identifier.")
    ...
    llm_connection_id: Optional[StrictStr] = Field(default=None, description="References connections.connection_id — Secure connections from Spartera to your databases and data warehouses. See GET /connections for valid values. Optional.")
    snippet_id: Optional[StrictInt] = Field(default=None, description="References snippets.snippet_id — Predefined code snippets to accelerate insight creation. See GET /snippets for valid values. Optional.")
    ...
    source: StrictStr = Field(description="Required. One of: MANUAL, AUTOMATIC.")
    ...
    allow_params: StrictBool = Field(description="Required.")
    accept_terms: StrictBool = Field(description="Required.")
