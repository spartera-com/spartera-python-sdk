...
class UsersUpdate(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="Enum type: StatusCodes")
    email_address: Optional[StrictStr] = None
    timezone: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["company_id", "function_id", "status", "email_address", "timezone"]
