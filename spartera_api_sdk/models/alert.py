...
class Alert(BaseModel):
    ...
    last_triggered: Optional[StrictStr] = None
    date_created: Optional[StrictStr] = None
    last_updated: Optional[StrictStr] = None
    active: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["alert_id", "asset_id", "user_id", "company_id", "alert_type", "is_active", "last_triggered", "date_created", "last_updated", "active"]
