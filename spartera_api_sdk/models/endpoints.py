...
class Endpoints(BaseModel):
    ...
    """ # noqa: E501
    date_created: datetime = Field(description="Required.")
    last_updated: datetime = Field(description="Required.")
    endpoint_id: Optional[StrictStr] = Field(default=None, description="Unique identifier.")
