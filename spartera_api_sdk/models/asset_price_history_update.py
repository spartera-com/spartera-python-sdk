...
class AssetPriceHistoryUpdate(BaseModel):
    ...
    date_ended: Optional[datetime] = Field(default=None, description="When did the price end (Datetime)")
    __properties: ClassVar[List[str]] = ["asset_id", "price_usd", "date_ended"]
