...
class CompaniesCompanyIdConnectionsConnectionIdDelete200ResponseData(BaseModel):
    """
    CompaniesCompanyIdConnectionsConnectionIdDelete200ResponseData
    """ # noqa: E501
    connection_id: StrictStr = Field(description="ID of the deleted connections")
    __properties: ClassVar[List[str]] = ["connection_id"]
