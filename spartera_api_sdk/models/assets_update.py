...
class AssetsUpdate(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="Enum type: Source")
    ...
    sell_in_marketplace: Optional[StrictBool] = None
    ...
    allow_params: Optional[StrictBool] = None
    accept_terms: Optional[StrictBool] = None
