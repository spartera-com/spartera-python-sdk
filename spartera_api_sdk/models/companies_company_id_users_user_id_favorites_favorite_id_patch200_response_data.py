...
class CompaniesCompanyIdUsersUserIdFavoritesFavoriteIdPatch200ResponseData(BaseModel):
    """
    CompaniesCompanyIdUsersUserIdFavoritesFavoriteIdPatch200ResponseData
    """ # noqa: E501
    favorite_id: StrictStr = Field(description="ID of the updated favorites")
