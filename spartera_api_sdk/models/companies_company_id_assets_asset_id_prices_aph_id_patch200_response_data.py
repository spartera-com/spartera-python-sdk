...
class CompaniesCompanyIdAssetsAssetIdPricesAphIdPatch200ResponseData(BaseModel):
    """
    CompaniesCompanyIdAssetsAssetIdPricesAphIdPatch200ResponseData
    """ # noqa: E501
    aph_id: StrictStr = Field(description="ID of the updated asset_price_history")
