...
class CompaniesCompanyIdUsersUserIdAlertsAlertIdDelete200ResponseData(BaseModel):
    """
    CompaniesCompanyIdUsersUserIdAlertsAlertIdDelete200ResponseData
    """ # noqa: E501
    alert_id: StrictStr = Field(description="ID of the deleted alerts")
    __properties: ClassVar[List[str]] = ["alert_id"]
