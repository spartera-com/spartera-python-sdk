...
class UsersApi:
    ...
    def create_users_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateUsers200Response]:
        """Create a new user
    ...
    def create_users_google_oauth(
        ...
        _param = self._create_users_google_oauth_serialize(
            company_id=company_id,
            users_input=users_input,
            page=page,
            limit=limit,
    ...
    @validate_call
    def create_users_google_oauth_with_http_info(
        self,
        company_id: Annotated[str, Field(min_length=1, strict=True, max_length=255, description="Unique identifier for the Company")],
        users_input: UsersInput,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
    ...
    @validate_call
    def create_users_google_oauth_without_preload_content(
        self,
        company_id: Annotated[str, Field(min_length=1, strict=True, max_length=255, description="Unique identifier for the Company")],
        users_input: UsersInput,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
    ...
    def _create_users_google_oauth_serialize(
        self,
        company_id,
        users_input,
        page,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/companies/{company_id}/users/google-oauth',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create_users_logout(
        ...
        _param = self._create_users_logout_serialize(
            company_id=company_id,
            users_input=users_input,
            page=page,
            limit=limit,
    ...
    @validate_call
    def create_users_logout_with_http_info(
        self,
        company_id: Annotated[str, Field(min_length=1, strict=True, max_length=255, description="Unique identifier for the Company")],
        users_input: UsersInput,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
    ...
    @validate_call
    def create_users_logout_without_preload_content(
        self,
        company_id: Annotated[str, Field(min_length=1, strict=True, max_length=255, description="Unique identifier for the Company")],
        users_input: UsersInput,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
    ...
    def _create_users_logout_serialize(
        self,
        company_id,
        users_input,
        page,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/companies/{company_id}/users/logout',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_users_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetUsersById200Response]:
        """Get single user by ID
    ...
    def list_users_me(
        ...
        _param = self._list_users_me_serialize(
            page=page,
            limit=limit,
            sort_by=sort_by,
            sort_order=sort_order,
    ...
    @validate_call
    def list_users_me_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="Field to sort by")] = None,
    ...
    @validate_call
    def list_users_me_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number for pagination")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
        sort_by: Annotated[Optional[StrictStr], Field(description="Field to sort by")] = None,
    ...
    def update_users_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateUsers200Response]:
        """Update an existing user by ID
