...
class UsersApi:
    ...
    def companies_company_id_users_post(
        ...
        :param company_id: (required)
        :type company_id: str
        :param users_input: (required)
        :type users_input: UsersInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def companies_company_id_users_user_id_patch(
        ...
        :param user_id: (required)
        :type user_id: str
        :param users_update: (required)
        :type users_update: UsersUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
